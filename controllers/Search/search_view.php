...
$s_cpu     = $_GET['cpu'] ?? '';
$s_ram     = $_GET['ram'] ?? '';
$s_storage = $_GET['storage'] ?? '';
$s_gpu     = $_GET['gpu'] ?? '';
$s_screen  = $_GET['screen'] ?? '';
$s_money    = $_GET['sort'] ?? '';  // ← Thêm dòng này
?>
...
<form method="GET" style="margin:20px 0; display: flex; flex-wrap: wrap; gap: 15px; align-items: end;">
    ...
    <div class="filter-group">
        ...
        <select name="cpu" style="padding: 5px;text-align: left;">
            ...
            <optgroup label="Intel">
                <option value="i3"    <?= $s_cpu == 'i3' ? 'selected' : '' ?>>Core i3 / Core 3</option>
                <option value="i5"    <?= $s_cpu == 'i5' ? 'selected' : '' ?>>Core i5 / Core 5</option>
                <option value="i7"    <?= $s_cpu == 'i7' ? 'selected' : '' ?>>Core i7 / Core 7</option>
                <option value="i9"    <?= $s_cpu == 'i9' ? 'selected' : '' ?>>Core i9 / Core 9</option>
                <option value="ultra" <?= $s_cpu == 'ultra' ? 'selected' : '' ?>>Core Ultra (AI)</option>
            </optgroup>
            <optgroup label="AMD">
                <option value="ryzen3" <?= $s_cpu == 'ryzen3' ? 'selected' : '' ?>>Ryzen 3</option>
                <option value="ryzen5" <?= $s_cpu == 'ryzen5' ? 'selected' : '' ?>>Ryzen 5</option>
                <option value="ryzen7" <?= $s_cpu == 'ryzen7' ? 'selected' : '' ?>>Ryzen 7</option>
                <option value="ryzen9" <?= $s_cpu == 'ryzen9' ? 'selected' : '' ?>>Ryzen 9</option>
            </optgroup>
            <optgroup label="Apple">
                <option value="m1" <?= $s_cpu == 'm1' ? 'selected' : '' ?>>Apple M1</option>
                <option value="m2" <?= $s_cpu == 'm2' ? 'selected' : '' ?>>Apple M2</option>
                <option value="m3" <?= $s_cpu == 'm3' ? 'selected' : '' ?>>Apple M3</option>
            </optgroup>
        </select>
    </div>
    ...
    <div class="filter-group">
        ...
        <select name="ram" style="padding: 5px;text-align: left;">
            <option value="">Tất cả</option>
            <option value="8"  <?= $s_ram == '8' ? 'selected' : '' ?>>8 GB</option>
            <option value="16" <?= $s_ram == '16' ? 'selected' : '' ?>>16 GB</option>
            <option value="32" <?= $s_ram == '32' ? 'selected' : '' ?>>32 GB</option>
            <option value="64" <?= $s_ram == '64' ? 'selected' : '' ?>>64 GB trở lên</option>
        </select>
    </div>
    ...
    <div class="filter-group">
        ...
        <select name="storage" style="padding: 5px;text-align: left;">
            <option value="">Tất cả</option>
            <option value="256"  <?= $s_storage == '256' ? 'selected' : '' ?>>256 GB</option>
            <option value="512"  <?= $s_storage == '512' ? 'selected' : '' ?>>512 GB</option>
            <option value="1024" <?= $s_storage == '1024' ? 'selected' : '' ?>>1 TB</option>
            <option value="2048" <?= $s_storage == '2048' ? 'selected' : '' ?>>2 TB</option>
        </select>
    </div>
    ...
    <div class="filter-group">
        ...
        <select name="gpu" style="padding: 5px; text-align: left;">
            <option value="">Tất cả</option>
            <option value="onboard"    <?= $s_gpu == 'onboard' ? 'selected' : '' ?>>Onboard (Văn phòng)</option>
            <option value="nvidia_rtx" <?= $s_gpu == 'nvidia_rtx' ? 'selected' : '' ?>>NVIDIA RTX (Gaming/Đồ họa)</option>
            <option value="nvidia_gtx" <?= $s_gpu == 'nvidia_gtx' ? 'selected' : '' ?>>NVIDIA GTX (Gaming cũ)</option>
            <option value="amd_rx"     <?= $s_gpu == 'amd_rx' ? 'selected' : '' ?>>AMD Radeon RX</option>
        </select>
    </div>

    <div class="filter-group">
        <label style="font-weight:bold; display:block">Màn hình:</label>
        <select name="screen" style="padding: 5px;text-align: left;">
            <option value="">Tất cả</option>
            <option value="13-14" <?= $s_screen == '13-14' ? 'selected' : '' ?>>Nhỏ gọn (13 - 14 inch)</option>
            <option value="15-16" <?= $s_screen == '15-16' ? 'selected' : '' ?>>Tiêu chuẩn (15.6 - 16 inch)</option>
            <option value="17"    <?= $s_screen == '17' ? 'selected' : '' ?>>Lớn (Trên 17 inch)</option>
        </select>
    </div>
    ...
    <div class="filter-group">
        ...
        <select name="sort" style="padding: 5px;text-align: left;">
            ...
            <option value="increase"  <?= $s_money == 'increase' ? 'selected' : '' ?>>Thấp → Cao</option>
            <option value="decreased" <?= $s_money == 'decreased' ? 'selected' : '' ?>>Cao → Thấp</option>
        </select>
    </div>
